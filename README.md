...
There are a number of changes which will be made before the official release, these changes are listed below, note we are in the process of making these updates and BETA users are encouraged to check for updates here
